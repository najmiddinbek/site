...
import LoginImg from "../public/5790719 1.jpg"
            ...
            <div className="flex justify-between items-center  h-[100vh]">
                <div data-aos='fade-up' className="w-[50%] border-r-2 mr-10 pr-">
                    ...
                    <div className="flex justify-center">
                        <Image src={LoginImg} width={350} height={200} alt="Image" />
                    </div>
                </div>
                <form data-aos="fade-down" onSubmit={handleSubmit} className="flex flex-col rounded-[20px] w-[50%]">
                    ...
                    <button className="bg-[#FEAF00] my-4 rounded-md text-white font-bold cursor-pointer px-6 py-3">
                        Ro`yxatdan o`tish
                    </button>
                    <button className="bg-white border-2 rounded-md text-[#344054] font-bold cursor-pointer px-6 py-3 flex justify-center items-center gap-2">
                        <FcGoogle size={24} />
